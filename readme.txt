...
Donate link: http://www.webdesi9.com/donate/?plugin=sticky-headers
Tags: sticky header, header, sticky, fixed, custom header, header fixed 
...
5. You can see the sticky header on frontend of your site.

== Screenshots ==

1. Sticky Headers Settings Page.
2. Sticky Headers front view on website.
